...
with col_hero:
    ...
    <div class='hero'>
        ...
        <div class='hero-title'>Economics • Data Analytics • AI</div>
        <div class='hero-rule'></div>
        <div class='hero-bio'>
            I build data-driven solutions using statistics, economics, and analytics. My work
            focuses on predictive modelling, business intelligence, interactive dashboards, and
            decision-support systems using Python, SQL, and modern visualization tools.
        </div>
        <div class='hero-meta'>
            <div class='hero-meta-item'><b>Education</b> · M.Sc. Economics, IIT Kanpur</div>
            <div class='hero-meta-item'><b>Graduate</b> · B.Sc. (Hons.) Statistics, Banaras Hindu University</div>
            <div class='hero-meta-item'><b>Location</b> · Varanasi, India</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
        ...
        <div style='display:grid;grid-template-columns:1fr 1fr;gap:40px;'>
            <div>
                ...
                <div class='flagship-desc'>
                    AI Inflation Advisor is an AI-powered economic forecasting platform currently
                    under development. The project combines statistical forecasting, machine
                    learning, and generative AI to explain inflation trends and support economic
                    decision-making through an interactive application.
                </div>
                ...
                <div class='flagship-meta'>PERSONAL PROJECT · AI + ECONOMICS · WORK IN PROGRESS</div>
            </div>
    ...
    for i, case in enumerate(CONSULTING_CASES):
        with [c1, c2][i]:
            ...
            <div class='consult-card'>
                ...
                <div style='margin-top:16px;'>
                    <span class='status-{case["status"]} status-badge'>{"WORKING ON" if case["status"]=="wip" else "COMING SOON"}</span>
                </div>
            </div>
            """, unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True)
...
<div class='contact-section' id='contact'>
    ...
    <div>
        ...
        <a class='contact-link' href='https://www.linkedin.com/in/shivank-byte'>in LinkedIn</a>
        <a class='contact-link' href='https://github.com/shivank-byte'>⌥ GitHub</a>
    </div>
</div>
<div class='footer'>
    <div class='footer-left'>ARTHASUTRA · 2025</div>
